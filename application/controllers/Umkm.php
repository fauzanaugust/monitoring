...
class Umkm extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('sess_moka') == TRUE) {
            ...
            $data['template']       = 'master/umkm/data.php';
    ...
    public function add()
	{
		if ($this->session->userdata('sess_moka') == TRUE) {
            ...
            $data['template']       = 'master/umkm/add.php';            
            $data['jsFile']         = 'umkmSave.js';
    ...
    public function doSave()
	{
		if ($this->session->userdata('sess_moka') == TRUE) {
            ...
            $insert = array(
                ...
                'kapasitasproduksi' => trim(strip_tags($this->input->post("kapasitasproduksi"))),
...
//            die;
    ...
    public function edit()
	{
		if ($this->session->userdata('sess_moka') == TRUE) {
            ...
            $data['template']       ="master/umkm/edit.php";                        
            $data['jsFile']         = 'umkmEdit.js';
