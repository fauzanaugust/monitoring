...
class panel extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('monitoring_session') == TRUE) {
            $data['template']       = 'master/panel/data.php';
	...
	{
		if ($this->session->userdata('monitoring_session') == TRUE) {
            $data['template']       = 'master/panel/add.php';            
            $data['jsFile']         = 'panelSave.js';
            $this->load->view('index', $data);
        }
        else
        {
...
//            die;
	...
	{
		if ($this->session->userdata('monitoring_session') == TRUE) {
            $data['template']       ="master/panel/edit.php";                        
            $data['jsFile']         = 'panelEdit.js';
