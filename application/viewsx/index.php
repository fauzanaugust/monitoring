...
<head>
    ...
    <title>Monitoring PJU | Kelurahan Jatiuwung</title>
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="true">
                        <img src="<?php echo base_url('assets/img/avatar/')?><?php echo $this->session->userdata('monitoring_session_avatar'); ?>" alt="Avatar" height="20px">
                        <i><strong><span></span><?php echo $this->session->userdata('monitoring_session_aliasname'); ?></strong></i>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light"><strong>PEDANG KARANG</strong></span>
            </a>
...
-->
                        <?php if($this->session->userdata('monitoring_session_role')=='Admin'):?>
                        
                        <li class="nav-item has-treeview <?= $this->uri->segment(1) == 'pju' || $this->uri->segment(1) == 'panel'  ? "menu-open" : '' ?>">
                            <a href="#" class="nav-link <?= $this->uri->segment(1) == 'pju' || $this->uri->segment(1) == 'panel'  ? "active" : '' ?>">
                                <i class="nav-icon far fa-lightbulb"></i>
                                <p>PJU Kampung Terang<i class="right fas fa-angle-left"></i></p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo site_url('pju'); ?>" class="nav-link <?php if($this->uri->segment(1)=='pju') echo 'active';?>">
                                        <i class="far fa-circle nav-icon"></i><p>Daftar PJU</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo site_url('panel'); ?>" class="nav-link <?php if($this->uri->segment(1)=='panel') echo 'active';?>"><i class="far fa-circle nav-icon"></i>
                                        <p>Daftar Panel</p>
                                    </a>
                                </li>
                            </ul>
...
-->
                        ...
                        <?php elseif($this->session->userdata('monitoring_session_role')=='pju'):?>
                        <li class="nav-item has-treeview <?= $this->uri->segment(1) == 'pju' || $this->uri->segment(1) == 'pju_anggota' ||  $this->uri->segment(1) == 'pju_produksi' ? "menu-open" : '' ?>">
                            <a href="#" class="nav-link <?= $this->uri->segment(1) == 'pju' || $this->uri->segment(1) == 'pju_anggota' ||  $this->uri->segment(1) == 'pju_produksi' ? "active" : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo site_url('pju_anggota'); ?>" class="nav-link <?php if($this->uri->segment(1)=='pju_anggota') echo 'active';?>"><i class="far fa-circle nav-icon"></i>
                                        <p>Anggota pju</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo site_url('pju_produksi'); ?>" class="nav-link <?php if($this->uri->segment(1)=='pju_produksi') echo 'active';?>">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2021 <a href="https://tangerangkota.go.id">Kelurahan Jatiuwung</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
