        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <button type="button" class="btn btn-block bg-gradient-primary" onclick="javascript:location.href='<?php echo base_url('kwt/add'); ?>'"><i class="icon fas fa-plus-circle"></i> Tambah Data</button>
                    </h3>
                </div>
                            ...
                            <?php
                                ...
                                SELECT 
                                    ...
                                    FROM
                                      ...
                                      WHERE tipe = 'KWT' ORDER BY nama_alias ASC
                                ");
    ...
    function editData(UID) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                window.location.href = BASE_URL + 'kwt/edit';
            }
        });
