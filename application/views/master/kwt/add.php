                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-sm-5">
                                         <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" id="nama_alias" name="nama_alias" placeholder="Isi Nama KWT">
                                         </div>
                                         <div class="form-group">
                                             <label>Nama Ketua</label>
                                             <input type="text" class="form-control" id="ketua" name="ketua" placeholder="Isi Nama Ketua">
                                         </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="input-group mb-3">
                                                 <input type="number" class="form-control" name="luaslahan" placeholder="Isi Kapasitas Produksi">
                                                 <div class="input-group-append">
                                                     <span class="input-group-text"><i class=""></i>m<sup>2</sup></span>
                                                 </div>
                                             </div>
                                         </div>
