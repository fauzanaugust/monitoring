                         ...
                         <div class="card-body">
                             <form method="post" action="" id="formData">
                                 <div class="row">
                                     ...
                                     <div class="col-sm-4">
                                         <div class="form-group">
                                             <label>Kode Panel</label>
                                             <input type="text" class="form-control" id="kode_pju" name="kode_pju" placeholder="Isi Kode panel" value="PANEL-">
                                         </div>
                                         <div class="form-row">
                                             <div class="form-group col-6">
                                                 <label>RW</label>
...
<!--
 <script>
     function getKelurahan() {
         ...
         $.ajax({
             type: "POST",
             url: BASE_URL + "panel/getKelurahan",
             data: {
                 DATA: URS
             },
             cache: false,
